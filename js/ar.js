...
if (isIOS()) {
  ...
  fetch(androidModelURL)
    ...
    .then(blob => {
      ...
      viewer.setAttribute("poster", fallbackImageURL); // Usar la imagen de fallback como poster
      ...
      viewer.setAttribute(
        "environment-image",
        "./models/textures/object_texture.png"
      );
    ...
    .catch(error => {
      ...
      // Mostrar la imagen de fallback en caso de error
